...
class Encoding(IntEnumLookup):
    ...
    POINTER_POS = -225
    # The rfbproto spec calls this PseudoPointerPosition.
    PSEUDO_POINTER_POS = -225
    TIGHT_226 = -226  # ... -238
    PSEUDO_CURSOR = -239
    PSEUDO_X_CURSOR = -240
    TIGHT_241 = -241  # ... -246
...
# Tight JPEG quality levels: -32 selects quality 0, -23 selects quality 9.
JPEG_QUALITY_ENCODINGS: dict[int, Encoding] = {
    quality: Encoding(-32 + quality) for quality in range(10)
}
